...
We have proposed a multi-modal human body segmentation approach using calibrated and registered multi-modal data. Furthermore, a novel registered and annotated multi-modal RGB-Depth-Thermal dataset of video sequences has been introduced, which contains several
