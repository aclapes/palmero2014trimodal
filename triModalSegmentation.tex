...
Table~\ref{tab:subject_detection_accuracy} illustrates the results obtained in the subject detection accuracy experiments with and without mirroring. Note we achieve nearly perfect detection when we only consider the two categories, 0 (object) and 1 (subject), omitting the -1 category prediction. The accuracy computation took into account the greater amount of subject regions, thus weighting the rate of detection of each category (0 and 1).
